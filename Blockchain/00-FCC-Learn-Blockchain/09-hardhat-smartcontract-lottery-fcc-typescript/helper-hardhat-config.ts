...
export interface networkConfigItem {
    ...
    raffleEntranceFee?: string | BigNumber
...
export const frontEndContractsFile =
    "../10-nextjs-smartcontract-lottery-fcc-typescript/constants/contractAddresses.json"
export const frontEndAbiFile =
    "../10-nextjs-smartcontract-lottery-fcc-typescript/constants/abi.json"
